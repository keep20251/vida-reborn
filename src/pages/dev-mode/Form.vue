  ...
  <Page>
    ...
    <template #default>
      ...
      <div v-else-if="tab === 2" class="my-10 grid space-y-20 px-20">
        <div>【 Text Style 】</div>
        <div class="text-xl font-bold leading-xl">Helvetica Neue-25-特重标题</div>
        <div class="text-lg font-bold leading-lg">Helvetica Neue-18-大标题</div>
        <div class="text-base font-normal leading-lg">Helvetica Neue-14-正文</div>
