    ...
    <template #default>
      <div class="flex flex-col space-y-20">
        ...
        <div class="flex flex-col space-y-10">
          <label class="text-left text-base font-normal not-italic leading-[0.875rem]">Tag</label>
        ...
        <div class="flex flex-col space-y-10">
          <label class="text-left text-base font-normal not-italic leading-[0.875rem]">
            誰可以看到
        ...
        <div class="flex flex-col space-y-10">
          <label class="text-left text-base font-normal not-italic leading-[0.875rem]">指定訂閱組</label>
