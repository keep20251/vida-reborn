...
export const LOCAL_STORAGE_KEYS = {
  ...
  INTERESTED_LIST: '__INTERESTED_LIST',
  RECENTLY_VIEWED_CREATORS: '__RECENTLY_VIEWED_CREATORS',
  RECENTLY_VIEWED_ARTICLES: '__RECENTLY_VIEWED_ARTICLES',
}
...
export const MODAL_TYPE = {
  ...
  SUBSCRIBE_SUCCESS_WITH_AVATAR: 36,
  SHOP_BUY_SUCCESS: 34,
  ADD_CREDIT_CARD: 35,
