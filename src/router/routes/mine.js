...
export default [
  ...
  { name: `${prefix}-profile-set`, path: `profile-set`, component: MineProfileSet, meta: { permissionKey: 'profile' } },
  {
    name: `${prefix}-profile-prvw`,
    path: `profile-prvw`,
    component: MineProfilePrvw,
    meta: { permissionKey: 'profile' },
  },
  {
    name: `${prefix}-earn`,
    path: `earn`,
    component: MineEarn,
    meta: { permissionKey: 'postEarn' },
  },
  {
    name: `${prefix}-earn-wdrl-req`,
    path: `earn-withdrawal-request`,
    component: MineEarnWdrlReq,
    meta: { permissionKey: 'postEarn' },
  },
  {
    name: `${prefix}-earn-wdrl-hist`,
    path: `earn-withdrawal-history`,
    component: MineEarnWdrlHist,
    meta: { permissionKey: 'postEarn' },
  },
  {
    name: `${prefix}-post`,
