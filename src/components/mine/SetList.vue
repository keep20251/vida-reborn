<template>
  <div class="flex select-none flex-col divide-y">
    <div v-if="role.registerLogin" class="grid space-y-5 py-10">
      ...
      <div class="flex cursor-pointer items-center space-x-5" @click="openAuthDialog()">
        <Icon name="setting" size="16"></Icon>
    ...
    <div v-if="role.settings" class="grid space-y-5 py-10">
      ...
      <div class="transition-all" :class="[{ 'pl-20': accOpen }]">
        <div class="flex w-full flex-col space-y-5 transition-all delay-1000" :class="{ hidden: !accOpen }">
          <router-link :to="{ name: 'mine-account' }" class="flex cursor-pointer items-center space-x-5">
            <Icon name="setting" size="16"></Icon><span>{{ $t('title.usnMail') }}</span>
          </router-link>
          <router-link :to="{ name: 'mine-password' }" class="flex cursor-pointer items-center space-x-5">
            <Icon name="setting" size="16"></Icon><span>{{ $t('title.password') }}</span>
          </router-link>
          <router-link :to="{ name: 'mine-preference' }" class="flex cursor-pointer items-center space-x-5">
            <Icon name="setting" size="16"></Icon><span>{{ $t('title.prefer') }}</span>
          </router-link>
          <router-link :to="{ name: 'mine-block' }" class="flex cursor-pointer items-center space-x-5">
            <Icon name="setting" size="16"></Icon><span>{{ $t('title.blockAcc') }}</span>
          </router-link>
          <router-link :to="{ name: 'mine-delete' }" class="flex cursor-pointer items-center space-x-5">
    ...
    <div class="grid space-y-5 py-10">
      ...
      <div class="transition-all" :class="[{ 'pl-20': aboutOpen }]">
        <div class="flex w-full flex-col space-y-5 transition-all delay-1000" :class="{ hidden: !aboutOpen }">
          <router-link :to="{ name: 'mine-tos' }" class="flex cursor-pointer items-center space-x-5">
            <Icon name="setting" size="16"></Icon><span>{{ $t('title.tos') }}</span>
          </router-link>
          <router-link :to="{ name: 'mine-pp' }" class="flex cursor-pointer items-center space-x-5">
            <Icon name="setting" size="16"></Icon><span>{{ $t('title.pp') }}</span>
          </router-link>
          <router-link :to="{ name: 'mine-cp' }" class="flex cursor-pointer items-center space-x-5">
            <Icon name="setting" size="16"></Icon><span>{{ $t('title.cp') }}</span>
          </router-link>
          <router-link :to="{ name: 'mine-dmca' }" class="flex cursor-pointer items-center space-x-5">
            <Icon name="setting" size="16"></Icon><span>DMCA</span>
          </router-link>
          <div class="flex items-center space-x-5"><Icon name="setting" size="16"></Icon><span>V1.0.0</span></div>
        </div>
      </div>
    </div>
