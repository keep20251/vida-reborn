  ...
  <div class="space-y-10 pb-20 pt-20 last:border-0 last:pb-0">
    <div class="flex justify-between">
      <div class="flex w-9/12 items-center space-x-5">
        ...
        <div class="w-8/12 break-words text-base font-normal leading-lg text-gray-57">
    ...
    <div class="flex items-baseline justify-between space-x-10">
      <div class="flex w-9/12 items-center space-x-5">
        ...
        <div class="w-8/12 break-words text-base font-normal leading-lg text-gray-57">{{ item.order_id }}</div>
      </div>
