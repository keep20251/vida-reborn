<template>
  <div>
    <div class="mb-20 text-center text-base font-bold leading-[1.125rem]">帖子主題：</div>
    <Loading v-if="isLoading"></Loading>
    <OptionsPicker v-else v-model="interested" :options="interestedOptions"></OptionsPicker>
    <div class="mt-30 text-center">
      <div class="text-base font-bold leading-[1.125rem]">至少選擇三個主題</div>
      <div class="text-base font-bold leading-[1.125rem]">太棒了！</div>
    </div>
  </div>
</template>
