<template>
  <div class="relative h-full w-full rounded-inherit">
    <EncryptImage :src="item.url[0]?.url_blur" :border-radius="10" cover></EncryptImage>
    <div class="absolute top-0 flex h-full w-full items-center justify-center rounded-inherit bg-[rgba(0,0,0,0.5)]">
