export default {
  ...
  common: {
    ...
    commentNoData: { 1: 'Belum ada komentar!', 2: 'Jadilah yang pertama berkomentar!' },
    more: 'Lebih',
    save: 'Menyimpan',
    reload: 'Muat ulang',
    ...
    editPersonalPage: 'Edit Halaman Pribadi',
  ...
  title: {
    ...
    search: { history: 'Riwayat Pencarian', clear: 'Pencarian Populer', popular: 'Hapus' },
  ...
  label: {
    ...
    private: 'Hanya Saya',
    reply: 'Membalas',
    subPlanName: 'Rencana Berlangganan',
    subPlanCtn: 'Deskripsi Rencana',
    subPlanPrice: 'Harga Rencana',
    subBtn: 'Berlangganan untuk membuka',
    buyBtn: 'Buka dengan pembelian',
  ...
  message: {
    ...
    error: {
      subscribeSelf: 'Tidak dapat berlangganan diri sendiri',
      shopBuySelf: 'Tidak dapat membeli produk sendiri',
      subscriptionNotFound: 'Tidak ada paket langganan yang tersedia',
    },
    sending: 'Mengirim',
    failure: 'Gagal',
  ...
  dialog: {
    subscription: {
      detail: {
        ...
        containFeeds: 'Posting',
        containTag: "{'#'}Mengandung {feeds} postingan",
  ...
  info: {
    ...
    time: 'Waktu',
    exitPrvw: 'Keluar pratinjau',
    uploadRule: 'Mendukung format mp4/mov.Mendukung format JPG/PNG, masing-masing tidak melebihi 1MB',
    ...
    subscription: {
      ...
      unlockSubscribe: 'Buka postingan {days} hari lalu',
      containFeeds: '#Mengandung {feeds} postingan',
    },
    valid: 'Berlaku',
  ...
  content: {
    default: 'Default, tidak boleh ditampilkan di mana pun',
    ...
    subStyle: 'Gaya Unggah',
    style: 'Tetapkan gaya sampul',
    subUnlockDayAfter: 'Membuka kunci postingan beberapa hari terakhir setelah pembelian',
    tokenExpired: 'Sesi login telah berakhir, silakan login kembali.',
    clearSearchHistory: 'Anda yakin ingin menghapus riwayat pencarian?',
    uploadVideoLimit: {
      format:
  ...
  meta: {
    ...
    creator: {
      title: '{nickname} - Pencipta di VIDA',
      description: 'Berlangganan {nickname} untuk lebih banyak pembaruan',
      keywords: '{nickname}, pencipta, VIDA',
    },
    post: {
      title: '{title} - Postingan dari {nickname} di VIDA',
      description: '{desc}',
  ...
  modal: {
    subscribe: {
      1: 'Akses penuh ke semua karya dari {days} hari terakhir',
      2: 'Dapat mengirim pesan langsung ke pembuatnya',
      3: 'Interaksi lebih dekat',
      4: 'Anda dapat membatalkan langganan kapan saja',
      confirm: "{'$'}{price} per bulan. Lanjutkan ke pembayaran",
    },
    shopBuy: {
      1: 'Akan membuka konten dari {nickname}',
      2: '{nickname} akan menerima pembayaran penuh Anda',
      confirm: "Buka kunci sekarang ({'$'}{price})",
    },
    subscribeSuc: {
      1: 'Keren! Berhasil berlangganan ke {nickname}!',
      2: 'Pilih untuk pergi ke halaman utama pembuat atau tetap di halaman saat ini!',
      confirm: 'Pergi ke halaman pembuat',
    },
    shopBuySuc: {
      1: 'Keren! Berhasil membuka kunci postingan dengan pembayaran!',
      2: 'Pilih untuk pergi ke postingan atau tetap di halaman saat ini!',
      confirm: 'Pergi ke postingan',
    },
    title: { paySuc: 'Pembayaran berhasil' },
    paying: { title: 'Memproses pembayaran' },
    payFailed: {
      title: 'Pembayaran gagal',
      content: 'Alasan rinci: {reason}. Silakan coba lagi, atau hubungi dukungan pelanggan',
    },
    confirmAmount: "Apakah jumlah yang Anda kirimkan {'$'}{price} benar?",
  ...
  beCreator: {
    ...
    title: {
      ...
      centerId: 'Pusatkan KTP',
    },
    content: {
      minePic: 'Foto saya',
      sendAfterConfirmPic: 'Kirim data setelah mengkonfirmasi foto',
      confirmSend: 'Apakah Anda yakin ingin mengirim data?',
      submitSuccess: 'Pilih dokumen dan mulai verifikasi',
    },
    btn: {
      takePicId: 'Pusatkan KTP',
      takePicFace: 'Foto saya',
      submit: 'Kirim data setelah mengkonfirmasi foto',
      startTakePic: 'Apakah Anda yakin ingin mengirim data?',
    },
    idAgreement: {
      1: 'Hebat! Informasi yang relevan telah berhasil dikirim. Kami akan menyelesaikan peninjauan Anda sesegera mungkin dalam tujuh hari, dan hasilnya akan diberitahukan kepada Anda melalui pesan. Terima kasih atas kesabaran Anda!',
      2: 'Kami akan membutuhkan Anda untuk mengambil 2 foto:',
      3: '1. Foto depan informasi ID',
      4: '2. Wajah pengguna dan foto depan informasi ID',
      5: 'Harap pastikan bahwa selama proses pemotretan:',
      6: 'Foto jelas terlihat',
      7: 'Ambil foto dalam lingkungan yang cukup terang',
      8: 'Jangan menghalangi wajah, pengenalan wajah yang jelas',
      9: 'Semua data pemotretan akan dijaga kerahasiaannya dan hanya digunakan untuk verifikasi identitas',
      10: 'Setelah memahami instruksi di atas, klik di bawah untuk mulai mengambil foto',
      11: 'Jika ada masalah selama proses ini, Anda akan dapat memulai ulang atau melanjutkan verifikasi dari halaman ini.',
      12: 'Anda juga dapat menghubungi dukungan dengan mengirim email',
    },
    agreement: {
      1: 'Informasi Penting - Harap baca dengan seksama',
      ...
      title: 'Setuju',
      btn: 'Setuju dan lanjutkan ke langkah berikutnya',
    },
  },
  official: {
    hero: {
