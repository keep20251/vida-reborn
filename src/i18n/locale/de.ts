export default {
  ...
  title: {
    ...
    search: { history: 'Historische Recherchen', clear: 'Beliebte Suchanfragen', popular: 'Klar' },
  ...
  meta: {
    ...
    creator: {
      ...
      description: '{displayName} ist ein Schöpfer auf VIDA, {bio}',
      keywords: 'Schöpfer, VIDA, Mitgliedsabonnement, Kreative Gemeinschaft',
    },
    post: {
  ...
  yup: {
    ...
    file: { required: 'Bitte laden Sie Dateien hoch' },
  },
  ...
  modal: {
    subscribe: {
      ...
      2: 'Möglichkeit, den Erstellern direkt Nachrichten zu senden',
      3: 'Eine engere Interaktion',
    ...
    subscribeSuc: {
      1: 'fabelhaft! {nickname} erfolgreich abonniert!',
      2: 'Gehen Sie entweder zur Homepage des Erstellers oder bleiben Sie auf dem Originalbildschirm und stöbern Sie!',
      confirm: 'Gehen Sie zur Erstellerseite',
    },
    shopBuySuc: {
    ...
    paying: { title: 'Die Zahlung wird bearbeitet' },
    payFailed: {
      title: 'Zahlungsfehler',
      content: 'Detaillierter Grund: {reason}. Bitte versuchen Sie es erneut oder wenden Sie sich an den Kundendienst',
    },
    confirmAmount: "Bitte geben Sie den zu zahlenden Betrag {'$'}{price} an",
