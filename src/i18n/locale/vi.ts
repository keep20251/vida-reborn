export default {
  ...
  common: {
    ...
    commentNoData: { 1: 'Chưa có bình luận nào!', 2: 'Hãy là người đầu tiên bình luận!' },
    more: 'Thêm',
    save: 'Cứu',
    reload: 'Tải lại',
  ...
  title: {
    ...
    search: { history: 'Lịch sử tìm kiếm', clear: 'Tìm kiếm phổ biến', popular: 'Xóa' },
  ...
  label: {
    ...
    reply: 'Hồi đáp',
    subPlanName: 'Kế hoạch đăng ký',
    subPlanCtn: 'Mô tả kế hoạch',
    subPlanPrice: 'Giá kế hoạch',
    subBtn: 'Đăng ký để mở khóa',
    buyBtn: 'Mua để mở khóa',
  ...
  message: {
    ...
    error: {
      subscribeSelf: 'Không thể đăng ký bản thân',
      shopBuySelf: 'Không thể mua sản phẩm của mình',
      subscriptionNotFound: 'Không có kế hoạch đăng ký nào có sẵn',
    },
    sending: 'Gửi',
    failure: 'Thất bại',
  ...
  dialog: {
    subscription: {
      detail: {
        ...
        containFeeds: 'Bài viết',
        containTag: "{'#'}Bao gồm {feeds} bài đăng",
  ...
  info: {
    ...
    time: 'Thời gian',
    exitPrvw: 'Thoát chế độ xem trước',
    ...
    subscription: {
      ...
      unlockSubscribe: 'Mở khóa bài viết {days} ngày qua',
      containFeeds: '#Bao gồm {feeds} bài đăng',
    },
    valid: 'Hợp lệ',
  ...
  content: {
    default: 'Mặc định, không nên hiển thị ở bất kỳ đâu',
    ...
    subStyle: 'Kiểu tải lên',
    style: 'Thiết lập kiểu bìa',
    subUnlockDayAfter: 'Sau khi mua, cho phép mở khóa bài viết trong vài ngày qua',
    tokenExpired: 'Phiên đăng nhập đã hết hạn, vui lòng đăng nhập lại.',
    clearSearchHistory: 'Bạn có chắc chắn muốn xóa lịch sử tìm kiếm không?',
    uploadVideoLimit: {
      format:
  ...
  meta: {
    ...
    creator: {
      title: '{nickname} - Người sáng tạo trên VIDA',
      description: 'Đăng ký {nickname} để nhận thêm cập nhật',
      keywords: '{nickname}, người sáng tạo, VIDA',
    },
    post: {
      title: '{title} - Bài đăng của {nickname} trên VIDA',
      description: '{desc}',
  ...
  yup: {
    ...
    file: { required: 'Vui lòng tải lên một tập tin' },
  },
  ...
  modal: {
    subscribe: {
      1: 'Quyền truy cập đầy đủ vào tất cả các tác phẩm trong {days} ngày qua',
      2: 'Có thể nhắn tin trực tiếp cho người sáng tạo',
      3: 'Tương tác gần gũi hơn',
      4: 'Bạn có thể hủy đăng ký bất cứ lúc nào',
      confirm: "{'$'}{price} mỗi tháng. Tiến hành thanh toán",
    },
    shopBuy: {
      1: 'Sẽ mở khóa nội dung của {nickname}',
      2: '{nickname} sẽ nhận được toàn bộ thanh toán của bạn',
      confirm: "Mở khóa ngay bây giờ ({'$'}{price})",
    },
    subscribeSuc: {
      1: 'Tuyệt vời! Đăng ký thành công {nickname}!',
      2: 'Chọn đi đến trang chủ của người sáng tạo hoặc ở lại trang hiện tại!',
      confirm: 'Đi đến trang của người sáng tạo',
    },
    shopBuySuc: {
      1: 'Tuyệt vời! Đã mở khóa bài viết thành công với thanh toán!',
      2: 'Chọn đi đến bài viết hoặc ở lại trang hiện tại!',
      confirm: 'Đi đến bài viết',
    },
    title: { paySuc: 'Thanh toán thành công' },
    paying: { title: 'Đang xử lý thanh toán' },
    payFailed: {
      title: 'Thanh toán thất bại',
      content: 'Lý do chi tiết: {reason}. Vui lòng thử lại hoặc liên hệ bộ phận hỗ trợ khách hàng',
    },
    confirmAmount: "Số tiền bạn đã gửi {'$'}{price} có đúng không?",
  ...
  beCreator: {
    ...
    title: {
      ...
      centerId: 'Đặt chứng minh thư ở giữa',
    },
    content: {
      minePic: 'Ảnh của tôi',
      sendAfterConfirmPic: 'Gửi dữ liệu sau khi xác nhận ảnh',
      confirmSend: 'Bạn có chắc chắn muốn gửi dữ liệu không?',
      submitSuccess: 'Chọn tài liệu và bắt đầu xác minh',
    },
    btn: {
      takePicId: 'Đặt chứng minh thư ở giữa',
      takePicFace: 'Ảnh của tôi',
      submit: 'Gửi dữ liệu sau khi xác nhận ảnh',
      startTakePic: 'Bạn có chắc chắn muốn gửi dữ liệu không?',
    },
    idAgreement: {
      1: 'Tuyệt vời! Thông tin liên quan đã được gửi thành công. Chúng tôi sẽ hoàn thành đánh giá của bạn trong vòng bảy ngày và sẽ thông báo kết quả cho bạn qua tin nhắn. Cảm ơn bạn đã kiên nhẫn!',
      2: 'Chúng tôi sẽ cần bạn chụp 2 ảnh:',
      3: '1. Ảnh mặt trước của thông tin ID',
      4: '2. Khuôn mặt người dùng và ảnh mặt trước của thông tin ID',
      5: 'Vui lòng đảm bảo rằng trong quá trình chụp:',
      6: 'Ảnh rõ ràng',
      7: 'Chụp ảnh trong môi trường có ánh sáng tốt',
      8: 'Không che khuất mặt, nhận diện khuôn mặt rõ ràng',
      9: 'Tất cả dữ liệu chụp sẽ được giữ bí mật nghiêm ngặt và chỉ được sử dụng để xác minh danh tính',
      10: 'Sau khi hiểu các hướng dẫn trên, hãy nhấp bên dưới để bắt đầu chụp ảnh',
      11: 'Nếu có bất kỳ vấn đề nào trong quá trình này, bạn sẽ có thể khởi động lại hoặc tiếp tục xác minh từ trang này.',
      12: 'Bạn cũng có thể liên hệ với bộ phận hỗ trợ bằng cách gửi email',
    },
    agreement: {
      1: 'Thông tin quan trọng - Vui lòng đọc kỹ',
      ...
      title: 'Đồng ý',
      btn: 'Đồng ý và tiến hành bước tiếp theo',
    },
  },
  official: {
    hero: {
