export default {
  ...
  tab: {
    recommand: 'Pour vous',
    subscribe: 'S’abonner',
    relatedAuthor: 'Auteur lié',
    relatedPost: 'Publication liée',
  ...
  common: {
    ...
    viewSubscribePlan: "Plans d'abonnement",
    cancel: 'Annuler',
    confirm: 'Confirmer',
    loading: 'Chargement',
    noMore: 'Pas plus',
    commentNoData: { 1: 'Pas encore de commentaires !', 2: 'Soyez le premier à commenter !' },
    more: 'Plus',
    save: 'Sauvegarder',
    reload: 'Recharger',
    ...
    editPersonalPage: 'Modifier la page personnelle',
  ...
  title: {
    ...
    search: { history: 'Historique de recherche', clear: 'Recherches Populaires', popular: 'Effacer' },
  ...
  label: {
    ...
    subBtn: "S'abonner pour débloquer",
    buyBtn: 'Débloquer avec achat',
  ...
  message: {
    ...
    error: {
      subscribeSelf: 'Vous ne pouvez pas vous abonner à vous-même',
      shopBuySelf: 'Vous ne pouvez pas acheter votre propre produit',
  ...
  dialog: {
    subscription: {
      detail: {
        ...
        containFeeds: 'Publications',
        containTag: "{'#'}Contient {feeds} publications",
  ...
  info: {
    ...
    uploadRule: 'Prend en charge le format mp4/mov.Prend en charge le format JPG/PNG, chacun ne dépassant pas 1MB',
    ...
    subscription: {
      ...
      unlockSubscribe: 'Débloquer posts de {days} jours',
      containFeeds: '#Contient {feeds} publications',
    },
    valid: 'Valide',
  ...
  content: {
    default: 'Par défaut, ne doit être affiché nulle part',
    ...
    style: 'Définir le style de couverture',
    subUnlockDayAfter: "Débloquer les posts des derniers jours après l'achat",
    tokenExpired: 'La session de connexion a expiré, veuillez vous reconnecter.',
    clearSearchHistory: "Êtes-vous sûr de vouloir effacer l'historique de recherche ?",
    uploadVideoLimit: {
      format:
  ...
  meta: {
    ...
    creator: {
      title: '{nickname} - Créateur sur VIDA',
      description: 'Abonnez-vous à {nickname} pour plus de mises à jour',
      keywords: '{nickname}, créateur, VIDA',
    },
    post: {
      title: '{title} - Publication de {nickname} sur VIDA',
      description: '{desc}',
  ...
  payment: {
    ...
    payway: { aliPay: 'Alipay', unionPay: 'UnionPay', creditCard: 'Carte de crédit', other: 'Autre', usdt: 'USDT' },
    popup: {
      ali: { title: 'Alipay sélectionné' },
      union: { title: 'UnionPay sélectionné' },
      other: { title: 'Autre sélectionné' },
      usdt: { title: 'USDT (TRC) sélectionné' },
  ...
  modal: {
    subscribe: {
      1: 'Accès complet à toutes les œuvres des {days} derniers jours',
      2: "Capable d'envoyer des messages directement au créateur",
      3: 'Interaction plus proche',
      4: 'Vous pouvez annuler votre abonnement à tout moment',
      confirm: "{'$'}{price} par mois. Procéder au paiement",
    },
    shopBuy: {
      1: 'Débloquera le contenu de {nickname}',
      2: '{nickname} recevra votre paiement complet',
      confirm: "Débloquer maintenant ({'$'}{price})",
    },
    subscribeSuc: {
      1: 'Génial ! Abonnement à {nickname} réussi !',
      2: "Choisissez d'aller à la page d'accueil du créateur ou de rester sur la page actuelle !",
      confirm: 'Aller à la page du créateur',
    },
    shopBuySuc: {
      1: 'Génial ! Publication débloquée avec succès grâce au paiement !',
      2: "Choisissez d'aller au post ou de rester sur la page actuelle !",
      confirm: 'Aller au post',
    },
    title: { paySuc: 'Paiement réussi' },
    paying: { title: 'Traitement du paiement' },
    payFailed: {
      title: 'Paiement échoué',
      content: 'Raison détaillée : {reason}. Veuillez réessayer, ou contacter le support client',
    },
    confirmAmount: "Le montant que vous avez soumis {'$'}{price} est-il correct ?",
  ...
  beCreator: {
    ...
    title: {
      ...
      centerId: "Centrez l'ID",
    },
    content: {
      minePic: 'Ma photo',
      sendAfterConfirmPic: 'Soumettre les données après avoir confirmé la photo',
      confirmSend: 'Êtes-vous sûr de vouloir envoyer les données ?',
      submitSuccess: 'Choisissez un document et commencez la vérification',
    },
    btn: {
      takePicId: "Centrez l'ID",
      takePicFace: 'Ma photo',
      submit: 'Soumettre les données après avoir confirmé la photo',
      startTakePic: 'Êtes-vous sûr de vouloir envoyer les données ?',
    },
    idAgreement: {
      1: 'Génial ! Les informations pertinentes ont été soumises avec succès. Nous compléterons votre révision dès que possible dans les sept jours, et le résultat vous sera notifié par message. Merci pour votre patience !',
      2: 'Nous aurons besoin de vous pour prendre 2 photos :',
      3: "1. Photo de face de l'information d'identification",
      4: "2. Visage de l'utilisateur et photo de face de l'information d'identification",
      5: 'Veuillez vous assurer que pendant le processus de prise de vue :',
      6: 'La photo est clairement visible',
      7: 'Prenez des photos dans un environnement bien éclairé',
      8: 'Ne bloquez pas le visage, reconnaissance faciale claire',
      9: "Toutes les données de tournage seront strictement confidentielles et utilisées uniquement pour la vérification d'identité",
      10: 'Après avoir compris les instructions ci-dessus, cliquez ci-dessous pour commencer à prendre des photos',
      11: "S'il y a des problèmes pendant ce processus, vous pourrez redémarrer ou continuer la vérification à partir de cette page",
      12: 'Vous pouvez également contacter le support en envoyant un e-mail',
    },
    agreement: {
      1: 'Informations importantes – Veuillez lire attentivement',
      ...
      title: 'Accepter',
      btn: "Accepter et passer à l'étape suivante",
    },
  },
  official: {
    hero: {
