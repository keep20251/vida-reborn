...
export default {
  ...
  content: {
    ...
    foodieRecipe: "Foodie/Recipe Creator",
    educatorTeaching: "Educator/Teaching Creator",
    photoInsta: "Photographer/Instagrammer",
    beautyFasion: "Beauty/Fashion Expert",
    travelPhoto: "Travel Blogger/Photographer",
    gameHost: "Game live host",
    lgScale: "Large scale content",
