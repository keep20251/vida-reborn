export default {
  ...
  title: {
    ...
    search: { history: 'Historical searches', clear: 'Popular Searches', popular: 'Clear' },
  ...
  message: {
    ...
    error: {
      subscribeSelf: "Can't subscribe to myself",
      shopBuySelf: "Can't buy your own products",
      subscriptionNotFound: 'No subscription plan available',
    },
    sending: '发送中',
    failure: '失败',
    imageSended: '图片已发送',
  ...
  content: {
    ...
    style: 'Style',
    subUnlockDayAfter: 'Allow unlocking posts within a few days after purchase?',
  ...
  modal: {
    subscribe: {
      ...
      2: 'Ability to message creators directly',
      3: 'A closer interaction',
    ...
    shopBuySuc: {
      1: 'marvelous! Successfully paid to unlock post',
      2: 'Choose to go to the post to watch, or stay on the original screen to browse!',
      confirm: 'Go to post',
    },
    title: { paySuc: 'Payment successfully made' },
    paying: { title: 'Payment is being processed' },
    payFailed: {
      title: 'Payment Fail',
      content: 'Detailed reason: {reason}. Please try again or contact customer service',
    },
    confirmAmount: "Please submit the amount {'$'}{price} to pay",
